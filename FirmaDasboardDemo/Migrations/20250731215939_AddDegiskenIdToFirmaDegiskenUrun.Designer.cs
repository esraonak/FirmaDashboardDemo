...
namespace FirmaDasboardDemo.Migrations
{
    ...
    [Migration("20250731215939_AddDegiskenIdToFirmaDegiskenUrun")]
    partial class AddDegiskenIdToFirmaDegiskenUrun
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirmaDasboardDemo.Models.FirmaDegiskenUrun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FirmaDegiskenId")
                        .HasColumnType("int");

                    b.Property<int?>("FirmaDegiskenUrunId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FirmaDegiskenId");

                    b.HasIndex("FirmaDegiskenUrunId");

                    b.HasIndex("UrunId");

                    b.ToTable("FirmaDegiskenUrunler");
                });
            ...
            modelBuilder.Entity("FirmaDasboardDemo.Models.FirmaDegiskenUrun", b =>
                {
                    b.HasOne("FirmaDasboardDemo.Models.FirmaDegisken", "FirmaDegisken")
                        .WithMany("FirmaDegiskenUrunler")
                        .HasForeignKey("FirmaDegiskenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FirmaDasboardDemo.Models.FirmaDegiskenUrun", null)
                        .WithMany("FirmaDegiskenUrunler")
                        .HasForeignKey("FirmaDegiskenUrunId");
            ...
            modelBuilder.Entity("FirmaDasboardDemo.Models.FirmaDegisken", b =>
                {
                    b.Navigation("FirmaDegiskenUrunler");
                });
